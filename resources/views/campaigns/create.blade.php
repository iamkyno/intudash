    ...
    <div class="col-md-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body" id="cost-estimator">
                ...
                <hr class="my-2">
                <div class="d-flex justify-content-between small mb-1">
                    <span class="text-muted">Internal Cost:</span>
                    <span id="est-cost">R 0.00</span>
                </div>
                <div class="d-flex justify-content-between small mb-1">
                    <span class="text-muted">Client Charge:</span>
...
function updateEstimator() {
    ...
    document.getElementById('est-cost').textContent = 'R ' + cost.toFixed(2);
    document.getElementById('est-charge').textContent = 'R ' + charge.toFixed(2);
