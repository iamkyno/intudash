    ...
    <div class="col-md-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body" id="cost-estimator">
                <p class="small mb-2" style="color:var(--text-tertiary);">
                    <i class="bi bi-info-circle me-1"></i>Costs are calculated from the recipients you select above — no typed guesses.
                </p>
                {{-- SMS rows --}}
